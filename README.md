...
| 구간 | 개선 전 | 개선 후 | 단축 |
|---|---:|---:|---:|
| 전체 로드 | 69.73초 | 42.53초 | 27.20초 |
| XML 파싱 및 patch 적용 | 5.57초 | 2.39초 | 3.18초 |
| 텍스처 로드 | 25.98초 | 2.62초 | 23.36초 |

전체 로드 시간 기준으로 약 39% 줄었다. 실제 단축 대부분은 텍스처 로드에서 발생했고, XML 전처리에서도 약 3초가 줄었다.
